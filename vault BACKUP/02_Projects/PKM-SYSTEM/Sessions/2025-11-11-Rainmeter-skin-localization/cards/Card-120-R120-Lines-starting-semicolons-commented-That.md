...
order: 120
role: assistant
created: '2025-11-11T00:21:44.853139Z'
tags:
- chat-card
- power-bi
- python
...
MF; Lines starting ; (semicolons) are commented out.
...
Y=52
W=190
H=1Modifie ce script pour que l'espace total utilise sur l'espace total soit lisible en un coup d'oeilAfficher plus
...
- ⬆️ Previous: [[Card-119-R119-Voici-modifications-apportées-Taille-car]]
- ⬇️ Next: [[Card-121-R121-Lines-starting-semicolons-commented-That]]
