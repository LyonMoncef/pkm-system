...
order: 88
role: assistant
created: '2025-11-10T21:08:50.302335Z'
tags:
- chat-card
- python
- receipts
...
Cette configuration utilise Claude par défaut (provider = 'claude'), mais vous pouvez facilement passer à OpenAI en changeant cette valeur.RéessayerClaude peut faire des erreurs. Assurez-vous de vérifier ses réponses.
...
- ⬆️ Previous: [[Card-087-R087-MFon-décomposer-ensemble-fichier-quarto]]
- ⬇️ Next: [[Card-089-R089-MFon-décomposer-ensemble-fichier-quarto]]
