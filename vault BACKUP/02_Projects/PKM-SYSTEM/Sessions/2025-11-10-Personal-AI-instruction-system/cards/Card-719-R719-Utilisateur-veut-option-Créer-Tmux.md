...
order: 719
role: assistant
created: '2025-11-10T21:46:15.751977Z'
tags:
- chat-card
- automation
attachments_count: 0
...
L'utilisateur veut l'option A: Créer le MOC Tmux + 5 raccourcis les plus utilisés.
Je vais créer:
...
Je vais faire des notes ultra concises comme demandé.
...
- ⬆️ Previous: [[Card-718-R718-Utilisateur-veut-option-Créer-Tmux]]
- ⬇️ Next: [[Card-720-R720-Utilisateur-veut-option-Créer-Tmux]]
