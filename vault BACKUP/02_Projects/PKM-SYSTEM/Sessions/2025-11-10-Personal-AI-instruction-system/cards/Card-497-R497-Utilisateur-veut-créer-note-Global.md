...
order: 497
role: assistant
created: '2025-11-10T21:46:12.672688Z'
tags:
- chat-card
- python
- obsidian
...
L'utilisateur veut créer une note \"Global Shortcuts System\" qui liste tous les raccourcis globaux (Layer 1) avec un Dataview en table.
Il veut:
...
- ⬆️ Previous: [[Card-496-R496-Utilisateur-veut-créer-note-Global]]
- ⬇️ Next: [[Card-498-R498-Utilisateur-veut-créer-note-Global]]
