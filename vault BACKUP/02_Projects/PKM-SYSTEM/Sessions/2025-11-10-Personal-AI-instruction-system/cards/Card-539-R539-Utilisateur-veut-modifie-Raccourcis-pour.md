...
order: 539
role: assistant
created: '2025-11-10T21:46:13.335264Z'
tags:
- chat-card
- python
- obsidian
...
L'utilisateur veut que je modifie le MOC Raccourcis pour remplacer les listes en dur par des requêtes Dataview dynamiques. Il faut:
...
Je vais créer des requêtes LIST ou TABLE selon ce qui est le plus approprié.
...
- ⬆️ Previous: [[Card-538-R538-Architected-dynamic-Dataview-queries-rem]]
- ⬇️ Next: [[Card-540-R540-Utilisateur-veut-modifie-Raccourcis-pour]]
