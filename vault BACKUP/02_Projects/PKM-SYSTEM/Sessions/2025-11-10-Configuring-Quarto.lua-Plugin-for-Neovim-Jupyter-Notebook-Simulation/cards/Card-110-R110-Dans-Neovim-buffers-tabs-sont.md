...
order: 110
role: assistant
created: '2025-11-10T21:08:50.539741Z'
tags:
- chat-card
- code
attachments_count: 0
...
Cette distinction est importante car dans Neovim (contrairement à certains éditeurs de texte classiques), un onglet n'équivaut pas à un fichier. Un onglet peut contenir plusieurs fenêtres affichant différents buffers, et le même buffer peut être affiché dans plusieurs onglets.Réessayer
...
- ⬆️ Previous: [[Card-109-S109-ID-msg-109]]
- ⬇️ Next: [[Card-111-R111-Dans-Neovim-buffers-tabs-sont]]
