...
order: 141
role: assistant
created: '2025-11-10T21:08:50.921996Z'
tags:
- chat-card
- python
- automation
...
Cette configuration utilise Claude par défaut (provider = 'claude'), mais vous pouvez facilement passer à OpenAI en changeant cette valeur.
...
- ⬆️ Previous: [[Card-140-R140-Plugin-avante-nvim-client-pour]]
- ⬇️ Next: [[Card-142-R142-Keymap-leader-Avante-desc-Open]]
